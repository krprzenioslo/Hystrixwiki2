...
Max number of requests allows to a [HystrixCommand.getFallback()](http://netflix.github.io/Hystrix/javadoc/com/netflix/hystrix/HystrixCommand.html#getFallback(\)) method from the calling thread.
...
Whether [HystrixCommand.getFallback()](http://netflix.github.io/Hystrix/javadoc/com/netflix/hystrix/HystrixCommand.html#getFallback(\)) will be attempted when failure or rejection occurs.
